...
def import_players_to_db(csv_file, db_file='nba_data.db'):
    ...
    cursor.execute('CREATE INDEX idx_players_player_id ON players(player_id)')
    cursor.execute('CREATE INDEX idx_players_player_name ON players(player_name)')
    cursor.execute('CREATE INDEX idx_players_is_active ON players(is_active)')
